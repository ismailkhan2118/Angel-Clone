...
function JobsModal() {
    ...
    return (
        <div className='jobs-modal-container'>
            <div className='jobs-modal-header'>Header
            </div>
            ...
            <div className='jobs-modal-salary-skills'>
                <div className='jobs-modal-salary'>
                    ...
                    <div className='modal-salary-range'>
                        <h5 className=''> ${value5[0]}k-${value5[1]}k</h5>

                        <Slider className="modal-skills-slider" value={value5} onChange={(e) => setValue5(e.value)} range="200" />
                    </div>
