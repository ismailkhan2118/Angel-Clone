    ...
    return (
        <div className="jobs-page-container">
            ...
            <div className="jobs-filters-div">
                ...
                <div className="filter-logo-btn" onClick={() => onClick('displayBasic2')}>
            ...
            <Dialog className="dialog-page" header="Apply Filters" visible={displayBasic2} footer={renderFooter('displayBasic2')} onHide={() => onHide('displayBasic2')}>
                <JobsModal></JobsModal>
            </Dialog>
